...
ip netns exec 11 bash -c "python3 ./throughput.py -o 11.throughput.json -s"
...
ip netns exec 1 bash -c "python3 ./throughput.py -o 1.throughput.json -s"
...
ip netns exec 3 bash -c "python3 ./throughput.py -o 3.throughput.json -s"
...
ip netns exec 13 bash -c "python3 ./throughput.py -o 13.throughput.json -s"
...
ip netns exec 2 bash -c "python3 ./throughput.py -o 2.throughput.json -s"
...
ip netns exec 0 bash -c "python3 ./throughput.py -o 0.throughput.json -s"
...
ip netns exec 12 bash -c "python3 ./throughput.py -o 12.throughput.json -s"
...
ip netns exec 14 bash -c "python3 ./throughput.py -o 14.throughput.json -s"
