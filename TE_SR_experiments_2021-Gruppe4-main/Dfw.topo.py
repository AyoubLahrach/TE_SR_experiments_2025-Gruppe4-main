...
class Dfw(Topo):
    def build(self):
        ...
        self.add_link_name("0", "2", cost=2000, delay=0.2, bw=40000, directed=True)
        self.add_link_name("2", "0", cost=2000, delay=0.2, bw=40000, directed=True)
        ...
        self.add_link_name("1", "2", cost=2000, delay=0.2, bw=40000, directed=True)
        self.add_link_name("2", "1", cost=2000, delay=0.2, bw=40000, directed=True)
        ...
        self.add_link_name("2", "3", cost=2000, delay=0.2, bw=40000, directed=True)
        self.add_link_name("3", "2", cost=2000, delay=0.2, bw=40000, directed=True)
        self.add_link_name("2", "4", cost=2000, delay=0.2, bw=40000, directed=True)
        self.add_link_name("4", "2", cost=2000, delay=0.2, bw=40000, directed=True)
    ...
    def dijkstra_computed(self):
        ...
        # Demand from 4 to 0
        build_str = ""
        nhlist = self.get_dijkstra_route_by_name("4","3")
        for nh in nhlist:
        ...
        # Demand from 1 to 3
        build_str = ""
        nhlist = self.get_dijkstra_route_by_name("1","4")
        for nh in nhlist:
        ...
        # Demand from 3 to 1
        build_str = ""
        nhlist = self.get_dijkstra_route_by_name("3","0")
        for nh in nhlist:
